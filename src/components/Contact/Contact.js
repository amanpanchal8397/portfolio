            ...
            <div className="contact__info" data-aos="fade-up">
              ...
              <div className="contact__info-details">
                <ul>
                  <li>
                    ...
                    <p>
                      <span>Address:&nbsp;&nbsp;</span>Gurgaon,Haryana
                    </p>
                  </li>
                  <li>
                    {" "}
                  ...
                  <li>
                    ...
                    <p>
                      <span>Email:&nbsp;&nbsp;</span>amanpanchal144@gmail.com
                    </p>
                  </li>
                  <li>
                    {" "}
              ...
              <div className="contact__social">
                <p className="contact__linkedin">
                  <a
                    href="https://www.linkedin.com/in/amanpanchal1/"
                ...
                <p className="contact__github">
                  <a
                    href="https://github.com/amannpanchal"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
